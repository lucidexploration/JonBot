...
public class GUI extends javax.swing.JFrame implements HotkeyListener {
    ...
    public GUI() throws IOException, AWTException {
        ...
        JIntellitype.getInstance().registerHotKey(1, 0, 45);
        JIntellitype.getInstance().registerHotKey(2, 0, KeyEvent.VK_PAUSE);
...
//        System.out.println(UUID.nameUUIDFromBytes(emailtest.getBytes()));
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Change F12 to Your High Heal Spell");
        ...
        jLabel14.setText("Change F11 to Your Low Heal Spell");
        ...
        jLabel24.setText("Insert button sends warlock combo on keys 1,2,3,4 with fight");
